...
namespace Game
{
    class Dealer
    {
        ...
        public Dealer(int numberofPlayers_, int maxNumberofCards_)
        {
        ...
        public Tuple<bool, string> deal()
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                for (int j = 0; j < numberofPlayers; j++)
                {
                    ...
                    int new_suit_pos = seed.Next(4); //random number between 0 and 3
                    int new_value = seed.Next(12); //card association : 2 = 0, 13 = A
                    ...
                    while (BeenDelt(new_card))
                    {
                        seed = new Random();
                        new_card = new Card();
                        new_suit_pos = seed.Next(4);
                        new_value = seed.Next(13); //card association : 2 = 0, 12 = A
